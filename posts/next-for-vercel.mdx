...
summary: "Vercel raises $40M in Series B led by GV, powering frontend development with Next.js. The company focuses on customer-obsessive development,  empowering developers to build fast and engaging websites."
